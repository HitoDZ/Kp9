function main_part(form) {
    ...
    if ((m <= 5) && (m >= 2) && (n <= 6) && (n >= 2)) {
        ...
        if (mas_a_max.id != mas_b_min.id) {
            ...
            document.getElementById("demo").innerHTML += '<br/><div class="ans">' + 'Ответ A: ' + mas_a_max.val + '</div>';
            document.getElementById("demo").innerHTML += '<div class="ans">' + 'Ответ B: ' + mas_b_min.val + '</div>';
            
        } else {
            document.getElementById(mas_a_max.id).className = "wind_color3";
            document.getElementById("demo").innerHTML += '<br/><br/><div class="ans">' + 'Ответ: ' + mas_a_max.val + '</div>';
        }
...
function new_post() {
    ...
    div.innerHTML = "<div class='modal_box'><p style='overflow-x:hidden; font-size: 25px; font-family: Impact;' > Неверные данные</p>" + "<p style='overflow-x:hidden;font-size: 17px;font-family: Impact;'>Попробуйте &nbsp; 2&le; m &le; 5 &nbsp; и  &nbsp; 2&le; n &le; 6</p>"  + '<br/>' +
